...
import {startLatestTestRunApplicantInfo} from "../../vars/latestTestRunApplicantInfo";
...
export const loginNew = async (page: any, url: any) => {
    ...
    startLatestTestRunApplicantInfo({
        email,
        password,
        firstName,
        lastName,
        phone,
        customUrl: process.env.ENVIRONMENT,
        hasCoApplicant: process.env.HASCOAPPLICANT === 'true',
